...
```
From this first plot, we can first notice that this time series has for the most part of it a **positive linear trend**, multiplicative seasonal patterns, and some irregular patterns. This plot suggests to use what we cal a SARIMA model to do our forecasting.
...
pvalue
```
We check with auto arima our final coefficient. 
The auto.arima function will provide us the best model. 
#Test auto.arima
```{r}
